package espejo.student_management_system.controller;

import espejo.student_management_system.factory.AuthWindowFactory;
import espejo.student_management_system.factory.StudentWindowFactory;
import espejo.student_management_system.repository.AuthRepository;
    ...
    private void handleLogin(ActionEvent event) {
        ...
        try {
            if (authRepository.authenticate(username, password)) {
                ...
                stage.setTitle("PUPSRC Student Management System");
